...
<template>
    ...
    <DrawerPortal>
      ...
      <DrawerContent class="fixed bottom-0 left-0 right-0 flex flex-col rounded-t-2xl bg-white h-[96dvh]">
        ...
        <div class="flex items-center justify-between px-4 pt-2 pb-2 shrink-0">
          <DrawerTitle class="text-lg font-semibold">Stacked (Layer 1)</DrawerTitle>
          <button
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4">
          <p class="text-gray-600">This is the first sheet. Open a second one on top of it.</p>
          <button
            class="w-full rounded-lg bg-purple-600 px-4 py-3 text-white font-medium active:bg-purple-700"
  ...
  <StackedSheetB v-if="showSecond" @close="showSecond = false" />
</template>
