...
<template>
  <DrawerRoot :open="open" :dismissible="false" @update:open="onOpenChange">
    <DrawerPortal>
      ...
      <DrawerContent class="fixed bottom-0 left-0 right-0 flex flex-col bg-white h-dvh">
        ...
        <div class="flex-1 flex items-center justify-center p-4">
          <p class="text-gray-500 text-center">This sheet takes the entire viewport.<br/>No drag handle, no rounded corners.</p>
        </div>
      </DrawerContent>
    </DrawerPortal>
  </DrawerRoot>
