    ...
    >
      <DrawerPortal>
        ...
        >
          ...
          />
          <div
            class="flex items-center justify-between px-4 pt-2 pb-2 shrink-0"
          >
...
const demoGroups = [
  {
    ...
    tests: (["small", "medium", "large"] as ModalSize[]).map((size) => ({
      id: `m-size-${size}`,
        ...
        openModal(
          {
            ...
            componentProps: { title: `${size.charAt(0).toUpperCase() + size.slice(1)} Modal` },
            size,
          },
          `Size: ${size}`,
        ),
  ...
  },
  {
    ...
    tests: [
      {
        id: "m-form-candismiss",
        label: "Form (canDismiss)",
        desc: "Swipe/backdrop blocked, escape allowed",
        fn: () =>
          openModal(
            {
      ...
      {
        id: "m-prevent-escape",
        label: "Prevent Escape",
        desc: "Escape key is blocked, backdrop allowed",
        fn: () =>
          openModal(
            {
              component: BasicContent,
              componentProps: { title: "No Escape!" },
              size: "medium",
              preventEscapeDismiss: true,
            },
            "Prevent escape",
          ),
      },
      {
        id: "m-prevent-backdrop",
        label: "Prevent Backdrop",
        desc: "Backdrop click blocked",
        fn: () =>
          openModal(
            {
              component: BasicContent,
              componentProps: { title: "Click backdrop — nothing happens" },
              size: "medium",
      ...
      {
        id: "m-persistent",
        label: "Persistent (no backdrop, no swipe)",
        desc: "Like auth modal — only close button works",
        fn: () =>
          openModal(
            {
              component: BasicContent,
              componentProps: { title: "Persistent Modal" },
              size: "small",
      ...
      },
      {
        ...
        desc: "canDismiss returns false for all — only close button works",
        fn: () =>
          openModal(
            {
              component: BasicContent,
              componentProps: { title: "Only close button works" },
              size: "medium",
              canDismiss: () => false,
            },
            "Block all",
      ...
      {
        id: "m-undismissable",
        label: "Undismissable (no close button)",
        desc: "No close, no escape, no backdrop, no swipe — auto-closes after 3s",
        fn: () =>
          openModal(
            {
  ...
  },
  {
    ...
    tests: [
      ...
      },
      {
        ...
        desc: "Sheet without drag handle indicator",
        fn: () =>
          openModal(
            {
              component: BasicContent,
              componentProps: { title: "No Handle" },
              size: "medium",
              showHandle: false,
            },
            "No handle",
      ...
      },
      {
        ...
        fn: () => {
          ...
          setTimeout(
            () => toast.success("I am above the modal!", { position: "top-right" }),
            500,
          );
        },
      },
    ...
    tests: [
      ...
      },
      {
        ...
        fn: () => {
          ...
          setTimeout(
            () => toast.success("I am above the drawer!"),
            600,
          );
        },
      },
