      ...
      <DrawerContent class="fixed bottom-0 left-0 right-0 flex flex-col rounded-t-2xl bg-white h-[96dvh]">
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4">
          <p class="text-gray-600">
            This sheet has three snap points: 25%, 50%, and 100%. Drag the handle to move between them.
          </p>
          <div class="rounded-lg bg-blue-50 p-3">
            <p class="text-sm text-blue-800">
              Try dragging the sheet up and down. It should snap to 25%, 50%, or 100% of the screen height.
            </p>
          </div>
