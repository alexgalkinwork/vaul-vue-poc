    ...
    <DrawerPortal>
      ...
      <DrawerContent class="fixed bottom-0 left-0 right-0 flex flex-col rounded-t-2xl bg-white max-h-[96dvh]">
        ...
        <div class="flex items-center justify-between px-4 pt-2 pb-2 shrink-0">
          <DrawerTitle class="text-lg font-semibold">Contact Form</DrawerTitle>
          <button
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4" data-vaul-no-drag>
          ...
          <div class="space-y-3">
            <div>
              ...
              <input v-model="name" type="text" placeholder="Enter your name" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-base focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none" />
            </div>
            <div>
            ...
            <div>
              ...
              <input v-model="phone" type="tel" placeholder="+49 123 456789" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-base focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none" />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea v-model="notes" rows="3" placeholder="Additional notes..." class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-base focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none resize-none" />
            </div>
          </div>

          <div class="flex gap-3">
            <button class="flex-1 rounded-lg border border-gray-300 px-4 py-3 font-medium active:bg-gray-50" @click="open = false">Cancel</button>
            <button class="flex-1 rounded-lg bg-blue-600 px-4 py-3 text-white font-medium active:bg-blue-700" @click="save">Save</button>
          </div>
        </div>
      </DrawerContent>
    </DrawerPortal>
