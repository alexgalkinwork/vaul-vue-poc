...
<template>
  <ToastProvider v-for="pos in positions" :key="pos" :duration="10000" swipe-direction="right">
    <ToastRoot
    ...
    >
      <div class="flex-1 min-w-0">
        ...
        <ToastDescription class="text-sm text-gray-700" v-html="getByPosition(pos)!.message" />
        <ToastAction
