    ...
    <DrawerPortal>
      ...
      <DrawerContent class="fixed bottom-0 left-0 right-0 flex flex-col rounded-t-2xl bg-white">
        ...
        <div class="flex items-center justify-between px-4 pt-2 pb-2 shrink-0">
          <DrawerTitle class="text-lg font-semibold">Pick an Option</DrawerTitle>
          <button
        ...
        <div class="p-4 space-y-4">
          <p class="text-sm text-gray-500">Select an option and save. The parent will receive the data.</p>
          ...
          <div class="space-y-2">
            ...
            >
              <input v-model="selectedOption" type="radio" :value="option" class="text-blue-600" />
              <span>{{ option }}</span>
            </label>
          </div>
